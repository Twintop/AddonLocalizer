...
public partial class LocalizationGridPageModel : ObservableObject, IQueryAttributable
{
    ...
    private async Task WriteGTFileAsync(string filePath, string baseLocale, Dictionary<string, string> translations)
    {
        ...
        // Build the list of manual translation file names for this base locale
        var manualTranslationFiles = string.Join(", ", wowLocaleCodes.Select(l => $"{l}.lua"));
        ...
        var lines = new List<string>
        {
            ...
            "",
            $"    1. Edit the manual translation file(s): {manualTranslationFiles}",
            "    2. Open a Pull Request on GitHub:",
            $"       {_appSettings.GitHubRepositoryUrl}",
            "",
